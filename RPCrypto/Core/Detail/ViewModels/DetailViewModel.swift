...
class DetailViewModel: ObservableObject {
    ...
    @Published var additionStatistics: [StatisticModel] = []
    ...
    private func addSubscribers() {
        ...
        coinDetailService.$coinDetails
            ...
            .sink { [weak self](returnedArrays) in
                ...
                self?.additionStatistics = returnedArrays.additional
            }
    ...
    private func createAdditionalArray(coinModel: CoinModel, coinDetailModel: CoinDetailModel?) -> [StatisticModel] {
        ...
        let highStat = StatisticModel(title: "24k High", value: high)
        
        let low = coinModel.low24H?.asCurrencyWith2Decimals() ?? "n/a"
        let lowStat = StatisticModel(title: "24k Low", value: low)
        ...
        let marketCapPercentChange = coinModel.marketCapChangePercentage24H
        let marketCapChangeStat = StatisticModel(title: "24h Market Cap Chance", value: marketCapChange, percentageChange: marketCapPercentChange)
